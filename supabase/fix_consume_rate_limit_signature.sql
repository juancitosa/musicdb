...
revoke all on function consume_rate_limit(text, integer, text, integer) from public, anon, authenticated;
grant execute on function consume_rate_limit(text, integer, text, integer) to service_role;

          ...
          return (
            ...
            >
              <svg aria-hidden="true" className="pointer-events-none absolute inset-0 h-full w-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                <defs>
                  <filter id="musicdb-toast-neon" x="-50%" y="-50%" width="200%" height="200%">
                ...
                <motion.rect
                  ...
                  ry="8"
                  fill="none"
                  stroke="rgba(186, 126, 255, 0.98)"
                  strokeWidth="0.72"
                  strokeLinecap="round"
                  filter="url(#musicdb-toast-neon)"
              ...
              <div
                className={`rounded-2xl border p-4 shadow-2xl ${
                  isDestructive ? "border-destructive/40 bg-destructive text-destructive-foreground" : "border-border bg-card text-card-foreground"
                }`}
              >
